        ...
        <div className="min-h-screen flex items-center justify-center p-4">
            <Card className="w-full max-w-md glass-morphism animate-scale-in">
                <CardHeader className="text-center space-y-4">
                    <div className="mx-auto w-16 h-16 rounded-full bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center animate-pulse">
                    ...
                    <CardDescription className="text-base">
                        Sign in to manage your company phone numbers
                    </CardDescription>
                </CardHeader>
                <CardContent>
                    <form
